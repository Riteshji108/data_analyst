...
import { ArrowDown, ArrowUpRight, BarChart3, BriefcaseBusiness, Database, Github, Linkedin, Mail, Menu, Moon, PieChart, Send, Sun, X } from "lucide-react";
      ...
      <section id="home" className="hero grid-bg">
        ...
        <div className="container hero-grid">
          <motion.div initial="hidden" animate="show" variants={fade}>
            ...
            <div className="socials"><a href="https://github.com/Riteshji108/data_analyst" aria-label="GitHub"><Github /></a><a href="https://linkedin.com/in/ritesh-pandey-46a64528" aria-label="LinkedIn"><Linkedin /></a><a href="mailto:riteshji289@gmail.com" aria-label="Email"><Mail /></a></div>
          </motion.div>
